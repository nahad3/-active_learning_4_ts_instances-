...
title_string = ['ANYmal B vel','ANYmal C vel','ANYmal B pos', 'ANYmal C pos', ' ', 'Sinusoids']
data_idx = 5
...
#leg = plt.legend(["Our Method w Entp", "Our Method w Mrg","Random","Max k entropy" ,"Coreset" ])
...
plt.title(title_string[data_idx])
fig.set_size_inches(12, 9)
plt.savefig(f'./results/plots/{data_type}2.png', dpi=100, bbox_inches='tight',pad_inches = 0 )